...
public static class PageTemplate
{
    ...
    [
        ...
        ("Structure", [("structure.html", "Structure", "🗀"), ("dependencies.html", "Dependencies", "⇄"),
                       ...
                       ("explore.html", "Explore", "🔎"), ("trace.html", "Trace", "🧭")]),
...
""";
    ...
    private const string TestsToggleButton =
    ...
    {
        IReadOnlyList<(string Section, (string Href, string Title, string Icon)[] Items)> navGroups =
            navItems is null ? NavSections : [("", [.. navItems])];
        ...
        var shell = new ShellOptions
        {
            ...
            ExtraFooterButtons = TestsToggleButton,
        };
