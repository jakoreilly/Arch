...
public static class PageTemplate
{
    ...
    [
        ...
        ("Schema", [("objects.html", "Objects", "❖"), ("domains.html", "Domains", "🗂"), ("er.html", "ER Diagram", "⬡"), ("relationships.html", "Relationships", "🔗"), ("dependencies.html", "Dependencies", "⇄"), ("graph.html", "Graph (3D)", "🕸"), ("crud.html", "CRUD Matrix", "▦")]),
